...
class JobResult(CommonResponseType):
    ...
    def __init__(self, account_number=None, credit_memo_numbers=None, invoice_numbers=None, order_number=None, paid_amount=None, payment_number=None, status=None, subscription_numbers=None, subscriptions=None):  # noqa: E501
