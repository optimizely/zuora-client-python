...
class RevenueSchedulesApi(object):
    ...
    def p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(self, body, cmi_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Creates a revenue schedule for a credit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        ...
        all_params = ['body', 'cmi_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(self, body, dmi_id, **kwargs):  # noqa: E501
        ...
        **Note:** This feature is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Creates a revenue schedule for a debit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        ...
        all_params = ['body', 'dmi_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(self, body, invoice_item_adj_key, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'invoice_item_adj_key', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(self, body, invoice_item_id, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'invoice_item_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ostr_sfor_subsc_charge_with_http_info(self, body, charge_key, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'charge_key', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ut_revenue_across_ap_with_http_info(self, body, rs_number, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'rs_number', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
