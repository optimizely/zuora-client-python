...
class GETAccountTypeMetrics(object):
    ...
    def __init__(self, balance=None, contracted_mrr=None, credit_balance=None, total_debit_memo_balance=None, total_invoice_balance=None, unapplied_credit_memo_amount=None, unapplied_payment_amount=None):  # noqa: E501
    ...
    def total_debit_memo_balance(self):
        ...
        **Note**: This field is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Total balance of all posted debit memos.   # noqa: E501
    ...
    def unapplied_credit_memo_amount(self):
        ...
        **Note**: This field is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Total unapplied amount of all posted credit memos.   # noqa: E501
    ...
    def unapplied_payment_amount(self):
        ...
        **Note**: This field is only available if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Total unapplied amount of all posted payments.   # noqa: E501
