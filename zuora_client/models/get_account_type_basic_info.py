...
class GETAccountTypeBasicInfo(object):
    ...
    def __init__(self, class__ns=None, customer_type__ns=None, department__ns=None, integration_id__ns=None, integration_status__ns=None, location__ns=None, subsidiary__ns=None, sync_date__ns=None, syncto_net_suite__ns=None, account_number=None, batch=None, communication_profile_id=None, credit_memo_template_id=None, crm_id=None, currency=None, debit_memo_template_id=None, id=None, invoice_template_id=None, name=None, notes=None, parent_id=None, sales_rep=None, sequence_set_id=None, status=None, tags=None):  # noqa: E501
