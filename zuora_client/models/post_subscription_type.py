...
class POSTSubscriptionType(object):
    ...
    def __init__(self, cpq_bundle_json_id__qt=None, opportunity_close_date__qt=None, opportunity_name__qt=None, quote_business_type__qt=None, quote_number__qt=None, quote_type__qt=None, integration_id__ns=None, integration_status__ns=None, project__ns=None, sales_order__ns=None, sync_date__ns=None, account_key=None, apply_credit_balance=None, auto_renew=False, collect=True, contract_effective_date=None, customer_acceptance_date=None, document_date=None, initial_term=None, initial_term_period_type=None, invoice=None, invoice_collect=True, invoice_owner_account_key=None, invoice_separately=None, invoice_target_date=None, notes=None, renewal_setting=None, renewal_term=None, renewal_term_period_type=None, run_billing=True, service_activation_date=None, subscribe_to_rate_plans=None, subscription_number=None, target_date=None, term_start_date=None, term_type=None):  # noqa: E501
