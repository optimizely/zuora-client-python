...
class ProxyModifyInvoice(object):
    ...
    def __init__(self, integration_id__ns=None, integration_status__ns=None, sync_date__ns=None, regenerate_invoice_pdf=None, status=None, transferred_to_accounting=None):  # noqa: E501
    ...
    def regenerate_invoice_pdf(self):
        """Gets the regenerate_invoice_pdf of this ProxyModifyInvoice.  # noqa: E501

        Whether to regenerate a PDF file for an invoice that already has PDF files generated.   For one specific invoice, you can use this field to regenerate PDF files for a maximum of 100 times.  **Note**: If you set this field to `true`, you cannot update any other fields in the same update request. Otherwise, you will receive the following INVALID_VALUE error:  \"When field RegenerateInvoicePDF is set to true to regenerate the invoice PDF file, changes on other fields of the invoice are not allowed.\"   # noqa: E501

        :return: The regenerate_invoice_pdf of this ProxyModifyInvoice.  # noqa: E501
        :rtype: bool
        """
    ...
    def regenerate_invoice_pdf(self, regenerate_invoice_pdf):
        """Sets the regenerate_invoice_pdf of this ProxyModifyInvoice.

        Whether to regenerate a PDF file for an invoice that already has PDF files generated.   For one specific invoice, you can use this field to regenerate PDF files for a maximum of 100 times.  **Note**: If you set this field to `true`, you cannot update any other fields in the same update request. Otherwise, you will receive the following INVALID_VALUE error:  \"When field RegenerateInvoicePDF is set to true to regenerate the invoice PDF file, changes on other fields of the invoice are not allowed.\"   # noqa: E501

        :param regenerate_invoice_pdf: The regenerate_invoice_pdf of this ProxyModifyInvoice.  # noqa: E501
        :type: bool
        """
