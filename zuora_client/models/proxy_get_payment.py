...
class ProxyGetPayment(object):
    ...
    def status(self):
        ...
        The status of the payment in Zuora. The value depends on the type of payment.  For electronic payments, the status can be `Processed`, `Processing`, `Error`, or `Voided`. For external payments, the status can be `Processed` or `Canceled`.   # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["Processed", "Processing", "Error", "Voided", "Canceled"]  # noqa: E501
