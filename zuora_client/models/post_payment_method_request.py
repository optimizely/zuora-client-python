...
from zuora_client.models.create_payment_method_ach import CreatePaymentMethodACH  # noqa: F401,E501
...
class POSTPaymentMethodRequest(object):
    ...
    swagger_types = {
        ...
        'security_code': 'str',
        'ach_bank_account_name': 'str',
        'ach_bank_account_number': 'str',
        'ach_bank_account_type': 'str',
        'ach_bank_name': 'str',
        'address_line1': 'str',
        'address_line2': 'str',
        'bank_aba_code': 'str',
    ...
    attribute_map = {
        ...
        'ach_bank_account_name': 'achBankAccountName',
        'ach_bank_account_number': 'achBankAccountNumber',
        'ach_bank_account_type': 'achBankAccountType',
    ...
    def __init__(self, baid=None, email=None, preapproval_key=None, card_holder_info=None, card_number=None, card_type=None, expiration_month=None, expiration_year=None, mit_consent_agreement_ref=None, mit_consent_agreement_src=None, mit_network_transaction_id=None, mit_profile_action=None, mit_profile_agreed_on=None, mit_profile_type=None, security_code=None, ach_bank_account_name=None, ach_bank_account_number=None, ach_bank_account_type=None, ach_bank_name=None, address_line1=None, address_line2=None, bank_aba_code=None, city=None, country=None, phone=None, state=None, zip_code=None, account_key=None, auth_gateway=None, make_default=False, type=None):  # noqa: E501
        ...
        self._ach_bank_account_name = None
        self._ach_bank_account_number = None
        self._ach_bank_account_type = None
        ...
        if ach_bank_account_name is not None:
            self.ach_bank_account_name = ach_bank_account_name
        if ach_bank_account_number is not None:
            self.ach_bank_account_number = ach_bank_account_number
        if ach_bank_account_type is not None:
            self.ach_bank_account_type = ach_bank_account_type
    ...
    def mit_profile_agreed_on(self):
        ...
        The date on which the profile is agreed. Required if you set the `mitProfileAction` field. The date format is `yyyy-mm-dd`.   # noqa: E501
    ...
    @property
    def ach_bank_account_name(self):
        """Gets the ach_bank_account_name of this POSTPaymentMethodRequest.  # noqa: E501
        ...
        :return: The ach_bank_account_name of this POSTPaymentMethodRequest.  # noqa: E501
        :rtype: str
        """
        return self._ach_bank_account_name

    @ach_bank_account_name.setter
    def ach_bank_account_name(self, ach_bank_account_name):
        """Sets the ach_bank_account_name of this POSTPaymentMethodRequest.

        The name of the account holder, which can be either a person or a company. This field is only required if the `type` field is set to `ACH`.   # noqa: E501

        :param ach_bank_account_name: The ach_bank_account_name of this POSTPaymentMethodRequest.  # noqa: E501
        :type: str
        """
        if ach_bank_account_name is not None and len(ach_bank_account_name) > 70:
            raise ValueError("Invalid value for `ach_bank_account_name`, length must be less than or equal to `70`")  # noqa: E501

        self._ach_bank_account_name = ach_bank_account_name

    @property
    def ach_bank_account_number(self):
        """Gets the ach_bank_account_number of this POSTPaymentMethodRequest.  # noqa: E501
        ...
        :return: The ach_bank_account_number of this POSTPaymentMethodRequest.  # noqa: E501
        :rtype: str
        """
        return self._ach_bank_account_number

    @ach_bank_account_number.setter
    def ach_bank_account_number(self, ach_bank_account_number):
        """Sets the ach_bank_account_number of this POSTPaymentMethodRequest.

        The bank account number associated with the ACH payment. This field is only required if the `type` field is set to `ACH`.   # noqa: E501

        :param ach_bank_account_number: The ach_bank_account_number of this POSTPaymentMethodRequest.  # noqa: E501
        :type: str
        """
        if ach_bank_account_number is not None and len(ach_bank_account_number) > 30:
            raise ValueError("Invalid value for `ach_bank_account_number`, length must be less than or equal to `30`")  # noqa: E501

        self._ach_bank_account_number = ach_bank_account_number

    @property
    def ach_bank_account_type(self):
        """Gets the ach_bank_account_type of this POSTPaymentMethodRequest.  # noqa: E501
        ...
        :return: The ach_bank_account_type of this POSTPaymentMethodRequest.  # noqa: E501
        :rtype: str
        """
        return self._ach_bank_account_type

    @ach_bank_account_type.setter
    def ach_bank_account_type(self, ach_bank_account_type):
        """Sets the ach_bank_account_type of this POSTPaymentMethodRequest.

        The type of bank account associated with the ACH payment. This field is only required if the `type` field is set to `ACH`.   # noqa: E501

        :param ach_bank_account_type: The ach_bank_account_type of this POSTPaymentMethodRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["BusinessChecking", "Checking", "Saving"]  # noqa: E501
        if ach_bank_account_type not in allowed_values:
            raise ValueError(
                "Invalid value for `ach_bank_account_type` ({0}), must be one of {1}"  # noqa: E501
                .format(ach_bank_account_type, allowed_values)
            )

        self._ach_bank_account_type = ach_bank_account_type

    @property
    def ach_bank_name(self):
        """Gets the ach_bank_name of this POSTPaymentMethodRequest.  # noqa: E501
        ...
        :return: The ach_bank_name of this POSTPaymentMethodRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def ach_bank_name(self, ach_bank_name):
        """Sets the ach_bank_name of this POSTPaymentMethodRequest.

        The name of the bank where the ACH payment account is held. This field is only required if the `type` field is set to `ACH`.   # noqa: E501

        :param ach_bank_name: The ach_bank_name of this POSTPaymentMethodRequest.  # noqa: E501
        :type: str
        """
        if ach_bank_name is not None and len(ach_bank_name) > 70:
            raise ValueError("Invalid value for `ach_bank_name`, length must be less than or equal to `70`")  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["PayPalEC", "PayPalNativeEC", "PayPalAdaptive", "CreditCard", "ACH"]  # noqa: E501
