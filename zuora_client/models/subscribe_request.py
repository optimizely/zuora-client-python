...
class SubscribeRequest(object):
    ...
    def preview_options(self):
        ...
        Only used if you want to call this operation in preview mode. After a call in preview mode is completed, Zuora will roll back the subscription and return only the temporary invoice data.   # noqa: E501
    ...
    def subscription_data(self):
        """Gets the subscription_data of this SubscribeRequest.  # noqa: E501
         ...
         This object contains the information on the contract's dates and terms.   **Values:** A valid SubscriptionData object.   # noqa: E501
