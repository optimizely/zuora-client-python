...
class POSTPaymentMethodType(object):
    ...
    def account_key(self):
        ...
        ID of the customer account to update.  **Note:** You can create a credit card payment method without assocating it with a customer account if you want. To do it and change the `accountKey` field to optional in this operation, submit a request at [Zuora Global Support](http://support.zuora.com/).   # noqa: E501
