...
class POSTSubscriptionPreviewResponseType(object):
    ...
    def credit_memo(self):
        """Gets the credit_memo of this POSTSubscriptionPreviewResponseType.  # noqa: E501
         ...
         Container for credit memos.  **Note:** This container is only available if you set the Zuora REST API minor version to 207.0 or later in the request header, and you have the Invoice Settlement feature enabled. The Invoice Settlement feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).    # noqa: E501
