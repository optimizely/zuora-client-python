...
class POSTPaymentMethodDecryption(object):
    ...
    def card_holder_info(self):
        ...
        Container for cardholder information. If provided, Zuora will only use this information for this card. If not provided, Zuora will use the account's existing bill-to contact information for this card.    # noqa: E501
