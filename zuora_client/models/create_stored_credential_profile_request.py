...
class CreateStoredCredentialProfileRequest(object):
    ...
    def __init__(self, action=None, agreed_on=None, auth_gateway=None, card_security_code=None, consent_agreement_ref=None, consent_agreement_src=None, status=None, type=None):  # noqa: E501
